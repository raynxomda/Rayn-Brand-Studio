      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="grid gap-14 md:grid-cols-[.85fr_1.15fr] md:gap-[9vw]">
          ...
          <div className="relative">
            ...
            <div className="mt-8 ml-auto max-w-[500px] border-l border-[#E8862E] pl-5 md:-ml-10 md:mt-[-2rem] md:relative md:z-10 md:max-w-[430px] md:bg-[#0B0B0C] md:py-5">
              <p className="font-display text-[clamp(1.8rem,3.2vw,3.1rem)] leading-[.95] tracking-[-.035em] text-[#F4F1EA]">
                “The best AI work doesn’t feel artificial. It feels <em className="text-[#E8862E]">inevitable.</em>”
              </p>
        ...
        <div className="mt-24 grid border-t border-white/10 pt-7 md:mt-36 md:grid-cols-[1fr_1.7fr] md:gap-[9vw]">
